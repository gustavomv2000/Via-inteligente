...
class VehicleGenerator:
    ...
    def update(self):
        """Add vehicles"""
        # print(random.random())
        # test = 1 if random.random() < 0.5 else -1
        # legacy = self.vehicle_rate
        # # print(self.vehicle_rate * test * (random.uniform(0, 12)/100))
        # print('legacy ', self.vehicle_rate)
        # self.vehicle_rate = self.vehicle_rate + (self.vehicle_rate * test * (random.uniform(0, 10)/100))
        # if self.vehicle_rate < legacy*0.9:
        #     self.vehicle_rate = legacy*0.9
        # print(self.vehicle_rate)
